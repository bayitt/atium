...
const classes =
  'size-8 flex justify-center items-center rounded-full cursor-pointer border border-[rgba(0,0,0,0.95)] transition-colors duration-500 ease-in bg-transparent hover:bg-[#ddd]'
...
<template>
  ...
  <div :class="classes" @click="handleShare('linkedin')">
    <FontAwesomeIcon icon="fa-brands fa-linkedin-in" style="color: rgba(0, 0, 0, 0.65)" size="sm" />
  </div>
</template>
