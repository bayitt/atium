...
const classes = "size-8 flex justify-center items-center rounded-full cursor-pointer border border-[rgba(0,0,0,0.95)] transition-colors duration-500 ease-in bg-transparent hover:bg-[#ddd]"
