...
<template>
  ...
  >
    <div class="px-[6%] sm:px-0 sm:col-span-8 lg:pr-5">
      <div class="w-fit flex gap-2 mb-4 relative z-10">
        <NuxtLink
      ...
      <div class="text-[1.02rem] sm:text-[0.92rem]/6 mb-4" v-html="excerpt + '...'" />
      <div v-if="series" class="w-fit text-[1.0rem] sm:text-[0.84rem] mb-4 relative z-10">
        Published in
        <NuxtLink
    ...
    <NuxtLink :to="slug" class="block absolute top-0 left-0 w-full h-full" />
  </div>
</template>
