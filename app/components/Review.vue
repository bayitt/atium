    ...
    <div>
      <div class="px-[6%] sm:px-0 sm:col-span-8 lg:pr-5">
        <div class="flex gap-2 mb-4">
          <div @click="navigate" role="link" v-for="(category, index) in categories" class="inline">
            <NuxtLink
              class="
                text-base
                sm:text-[0.85rem]
        ...
        <div v-if="series" class="text-[1.0rem] sm:text-[0.84rem] mb-4">
          Published in
          <div @click="navigate" role="link" class="inline">
            <NuxtLink
